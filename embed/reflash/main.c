...
// dd if=/dev/zero of=./image.bin bs=1 count=180224
// dd if=build/boardloader/boardloader.bin of=./image.bin bs=1
// dd if=build/bootloader/bootloader.bin of=./image.bin bs=1 seek=49152
